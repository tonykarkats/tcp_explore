...
BulkSendHelper::BulkSendHelper (std::string protocol, Address address, Address addressSender, std::string filename)
{
  m_factory.SetTypeId ("ns3::BulkSendApplication");
  m_factory.Set ("Protocol", StringValue (protocol));
  m_factory.Set ("Remote", AddressValue (address));
  m_factory.Set("Local", AddressValue(addressSender));

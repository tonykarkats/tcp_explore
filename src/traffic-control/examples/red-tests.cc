...
main (int argc, char *argv[])
{
  ...
  csma.SetChannelAttribute ("DataRate", StringValue (redLinkDataRate));
  csma.SetChannelAttribute ("Delay", StringValue (redLinkDelay));
  NetDeviceContainer devn2n3 = csma.Install (n2n3);

 ...
 */
#ifndef PATH_HASHING_HELPER_H
#define PATH_HASHING_HELPER_H
 ...
 */
class PathHashingHelper
{
public:
  /*
   * Construct a PathHashingHelper
   */
  PathHashingHelper ();
  /**
   * Set an attribute on each ns3::BridgeNetDevice created by
   * PathHashingHelper::Install
   *
   ...
   * configured by PathHashingHelper::SetDeviceAttribute, adds the device

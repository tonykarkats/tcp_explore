 ...
 */
#ifndef PATH_HASHING_CHANNEL_ADV_H
#define PATH_HASHING_CHANNEL_ADV_H
 ...
 * PathHashingAdvChannel aggregates multiple channels and make them appear as
 * a single channel to upper layers.
 */
class PathHashingAdvChannel : public Channel
{
public:
  /**
  ...
  PathHashingAdvChannel ();
  virtual ~PathHashingAdvChannel ();
...
private:
   ...
   */
  PathHashingAdvChannel (const PathHashingAdvChannel &);
   ...
   * \returns
   */
  PathHashingAdvChannel &operator = (const PathHashingAdvChannel &);
...
#endif /* PATH_HASHING_CHANNEL_ADV_H */
